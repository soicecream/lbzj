<template>
  <div class="mavonEditor">
    <mavon-editor ref="md" @imgAdd="$imgAdd" @imgDel="$imgDel" :ishljs="true" :html="openHtml" :autofocus="false"
                  :toolbars="toolbars" v-model="currentValue" codeStyle="arduino-light">
      <template v-slot:left-toolbar-after v-if="isAdminRole">
        <button type="button" title="上传文件" class="op-icon fa markdown-upload" aria-hidden="true" @click="uploadFile">
...
export default {
  ...
  props: {
    ...
    openHtml: {type: Boolean, default: true,},
  },
  data() {
    return {
      isAdminRole: false,
